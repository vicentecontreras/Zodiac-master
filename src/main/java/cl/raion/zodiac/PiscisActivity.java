...
public class PiscisActivity extends AppCompatActivity {
    ImageView imgzodiac;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgzodiac.setImageResource(R.drawable.piscis);
        nombrezodiac = (TextView) findViewById(R.id.tvSelectedZodiac);
        nombrezodiac.setText(R.string.piscis);
        tvzodiacfechas = (TextView) findViewById(R.id.tvZodiacFechas);
        tvzodiacfechas.setText(R.string.txt_piscis_fecha);
        tvZodiacDesc = (TextView) findViewById(R.id.tvZodiacDesc);
        tvZodiacDesc.setText(R.string.txt_piscis_desc);
    }
}
