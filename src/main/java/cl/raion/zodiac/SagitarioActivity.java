...
public class SagitarioActivity extends AppCompatActivity {
    ImageView imgzodiac;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgzodiac.setImageResource(R.drawable.sagitario);
        nombrezodiac = (TextView) findViewById(R.id.tvSelectedZodiac);
        nombrezodiac.setText(R.string.sagitario);
        tvzodiacfechas = (TextView) findViewById(R.id.tvZodiacFechas);
        tvzodiacfechas.setText(R.string.txt_sagitario_fecha);
        tvZodiacDesc = (TextView) findViewById(R.id.tvZodiacDesc);
        tvZodiacDesc.setText(R.string.txt_sagitario_desc);
    }
}
