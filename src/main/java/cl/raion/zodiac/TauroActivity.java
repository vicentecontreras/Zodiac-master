...
public class TauroActivity extends AppCompatActivity {
    ImageView imgzodiac;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgzodiac.setImageResource(R.drawable.tauro);
        nombrezodiac = (TextView) findViewById(R.id.tvSelectedZodiac);
        nombrezodiac.setText(R.string.tauro);
        tvzodiacfechas = (TextView) findViewById(R.id.tvZodiacFechas);
        tvzodiacfechas.setText(R.string.txt_tauro_fecha);
        tvZodiacDesc = (TextView) findViewById(R.id.tvZodiacDesc);
        tvZodiacDesc.setText(R.string.txt_tauro_desc);
    }
}
